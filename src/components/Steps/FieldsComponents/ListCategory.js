...
import { setCategories } from '../../../store/addRecipeSlice';
...
export default function ListCategory() {
  ...
  const recipeCategories = useSelector((state) => state.addRecipe.categories) || [];  // const [value, setValue] = React.useState(recipeCategories); // Initialize value with recipeCategories
...
, [categories]);
  ...
  return (
    <Root>
      <div {...getRootProps()}>
        {/* <Label {...getInputLabelProps()}>קטגוריה</Label> */}
